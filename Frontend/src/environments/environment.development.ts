...
export const environment: Environment = {
  ...
  AUTHORIZE_URL:
    'https://discord.com/api/oauth2/authorize?client_id=1088577340709281812&redirect_uri=https%3A%2F%2Flocalhost%3A3000%2Fauth%2Fcallback&response_type=code&scope=guilds',
  ADD_BOT_URL:
